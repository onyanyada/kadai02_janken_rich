...
- ハードモード：合計点が減る
- scenario.jsの簡潔なコード：メンター今吉さんが長文で改正したコードと解説をしてくれたためできました(私がやったことは99%コピペだが、今後も何度も読み直し、次のコードに生かしたい)
...
- メンターの方々や前回の講義から問題を切り分けたり、一つずつ値をConsoleに出してどこまでできているか確認することの大切さを教わり、そのおかげでかなり解決力があがったと思います。ありがとうございました！
